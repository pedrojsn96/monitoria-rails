...
class QualificacoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qualificacao" do
    assert_difference('Qualificacao.count') do
      post qualificacoes_url, params: { qualificacao: { cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id } }
    end
  ...
  test "should update qualificacao" do
    patch qualificacao_url(@qualificacao), params: { qualificacao: { cliente_id: @qualificacao.cliente_id, nota: @qualificacao.nota, restaurante_id: @qualificacao.restaurante_id } }
